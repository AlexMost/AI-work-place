...
<img src="img/codebase-size.svg" alt="Маленька кодова база — агент легко орієнтується; велика — губиться й блукає" style="width: 94%; max-height: 80vh; border: none; background: none; box-shadow: none;" />

Note:
Чим більша кодова база, тим важче агенту самому зрозуміти, де що лежить і що потрібно змінити: він губиться, перечитує файли, блукає. На маленькому проєкті це не проблема — все на видноті. Саме тому великим репо потрібен harness, який допомагає агенту орієнтуватися.

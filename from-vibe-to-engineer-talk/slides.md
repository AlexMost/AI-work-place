...
<span class="fragment chip">прототип</span>
<span class="fragment chip">лендінг</span>
<span class="fragment chip">особиста тулза</span>
<span class="fragment chip">демо для пітчу</span>
<span class="fragment chip">експеремент</span>
</div>
...
## Від думки до реалізації тебе відділяють лише токени та здатність сформулювати, чого хочеш
